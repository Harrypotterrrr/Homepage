...
![gan-2-13](https://s1.ax1x.com/2022/04/13/LuDMZQ.png){:style="margin:auto;display:block;"}
...
![gan-2-14](https://s1.ax1x.com/2022/04/13/LuDMZQ.png){:style="margin:auto;display:block;"}
...
![gan-2-15](https://s1.ax1x.com/2022/04/13/LuDMZQ.png){:style="margin:auto;display:block;"}
...
![gan-2-16](https://s1.ax1x.com/2022/04/13/LuDMZQ.png){:style="margin:auto;display:block;"}
...
![gan-2-17](https://s1.ax1x.com/2022/04/13/LuDMZQ.png){:style="margin:auto;display:block;"}
...
1. [Machine Learning And Having It Deep And Structured 2018 Spring, Hung-yi Lee](https://speech.ee.ntu.edu.tw/~hylee/mlds/2018-spring.php)
1. [StackGAN: Text to Photo-realistic Image Synthesis with Stacked Generative Adversarial Networks](https://arxiv.org/abs/1612.03242)
...
1. [Unpaired Image-to-Image Translation using Cycle-Consistent Adversarial Networks](https://arxiv.org/abs/1703.10593)
1. [Learning to Discover Cross-Domain Relations with Generative Adversarial Networks](https://arxiv.org/abs/1703.05192)
1. [DualGAN: Unsupervised Dual Learning for Image-to-Image Translation](https://arxiv.org/abs/1704.02510)
...
1. [Coupled Generative Adversarial Networks](https://arxiv.org/abs/1606.07536)
1. [Unsupervised Image-to-Image Translation Networks](https://arxiv.org/abs/1703.00848)
1. [Fader Networks: Manipulating Images by Sliding Attributes](https://arxiv.org/abs/1706.00409)
1. [ComboGAN: Unrestrained Scalability for Image Domain Translation](https://arxiv.org/abs/1712.06909)
1. [XGAN: Unsupervised Image-to-Image Translation for Many-to-Many Mappings](https://arxiv.org/abs/1711.05139)