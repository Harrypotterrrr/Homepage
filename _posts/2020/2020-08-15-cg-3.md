...
**Note**: Objects may be sctretched out of the original scale, so the next [viewport transform](2020-08-19-cg-4.md#canonical-cube-to-screen) will deal with this and draw it back to the original scale.
{:.warning}
