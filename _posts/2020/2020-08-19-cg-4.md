...
- For now: A pixel is a little square with uniform color. [Not strictly]
...
- Use three [cross product](2020-08-11-cg-2.md#cross-product) to check if the Point is inside the triangle or not.
